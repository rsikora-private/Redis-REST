...
import com.robertsikora.core.repo.impl.RedisRepoImpl;
...
public abstract class CommonServiceImpl<E extends RedisEntity>
    ...
    private RedisRepoImpl<E, Long> redisRepo;
    ...
    @Required
    public void setRedisRepo(final RedisRepoImpl<E, Long> redisRepo) {
